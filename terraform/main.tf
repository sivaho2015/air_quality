...
resource "aws_security_group" "dagster_security_group" {
  ...
  description = "Security group to allow inbound SCP & outbound 8080 (Dagster) connections"
...
resource "aws_instance" "air_quality_ec2" {
...
resource "aws_budgets_budget" "ec2" {
  ...
  time_period_start = "2023-09-30_00:00"
  time_unit         = "MONTHLY"
